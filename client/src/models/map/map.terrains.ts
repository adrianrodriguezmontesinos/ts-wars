...
export const terrainSprites: Record<TerrainType, Sprite> = {
  ...
  [TerrainType.GRASS2]: new Sprite(buildingsTile, 4, 10, TERRAIN_SPRITE_WIDTH, TERRAIN_SPRITE_HEIGTH),
  [TerrainType.GRASS3]: new Sprite(buildingsTile, 4, 8, TERRAIN_SPRITE_WIDTH, TERRAIN_SPRITE_HEIGTH),
  [TerrainType.GRASS4]: new Sprite(buildingsTile, 4, 5, TERRAIN_SPRITE_WIDTH, TERRAIN_SPRITE_HEIGTH),
  [TerrainType.GRASS5]: new Sprite(buildingsTile, 4, 7, TERRAIN_SPRITE_WIDTH, TERRAIN_SPRITE_HEIGTH),

  [TerrainType.DESERT]: new Sprite(buildingsTile, 2, 3, TERRAIN_SPRITE_WIDTH, TERRAIN_SPRITE_HEIGTH),
  [TerrainType.DESERT2]: new Sprite(buildingsTile, 1, 11, TERRAIN_SPRITE_WIDTH, TERRAIN_SPRITE_HEIGTH),
  [TerrainType.DESERT3]: new Sprite(buildingsTile, 1, 9, TERRAIN_SPRITE_WIDTH, TERRAIN_SPRITE_HEIGTH),
  [TerrainType.DESERT4]: new Sprite(buildingsTile, 1, 6, TERRAIN_SPRITE_WIDTH, TERRAIN_SPRITE_HEIGTH),
  [TerrainType.DESERT5]: new Sprite(buildingsTile, 1, 7, TERRAIN_SPRITE_WIDTH, TERRAIN_SPRITE_HEIGTH),
